          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-5">
                ...
                <Textarea id="message" name="message" value={formData.message} onChange={handleChange} placeholder="Tell me about your project, questions, or just say hello..." required className="h-32" />
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:johndoe@example.com" className="text-blue-600 hover:underline">dormut75@gmail.com</a>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="tel:+11234567890" className="text-blue-600 hover:underline">(+254) 790063153</a>
                </div>
              </div>
